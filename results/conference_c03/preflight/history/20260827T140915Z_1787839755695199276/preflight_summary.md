...
- Error: tracked repository state is not the clean AMD branch plus only the expected applied llama.cpp diagnostic patch: ['M conference/tools/c03_amd_preflight.py', ' M llama.cpp']
